        ...
        <div class="border-top border-bottom py-4 mb-4">
            ...
            {!! Form::open(['route' => ['cursos.review', $curso]]) !!}
                ...
                <div class="media">
                    ...
                    <img class = "mr-3 img-thumbnail rounded-circle" src="{{asset(auth()->user()->picture)}}" alt="" style="width:  60px">
    ...
    <ul class="list-unstyled">
        ...
        @forelse ($curso->reviews as $review)
            ...
            <li class="mb-3 border-bottom">
                ...
                <div class="media">
                    <img class = "mr-3 img-thumbnail rounded-circle" src="{{asset($review->user->picture)}}" alt="" style="width:  60px">
